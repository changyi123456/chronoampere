...
export const PROLOGUE = {
  ...
  lines: [
    ...
    '導師失蹤前留下一台無法自行供電的「時光電弧儀」，以及一份互相矛盾的任務：',
    '「六項關鍵發現被人動了手腳。重現它們——但別急著相信『修復』這兩個字。」',
    '',
    '六項實驗分別對應時光電弧儀的調節、分流、導航、顯示、感應與耦合模組。',
    '每重現一項，機器就更完整；每完整一步，你也更接近導師不敢替你做的選擇。',
    '',
    '每個年代都留著一張紙。它們有未來的符號、錯誤的日期與熟悉的書寫習慣，',
    '卻都與原始史料一起老化，沒有任何被後人塞入的痕跡。',
    '',
    '你不只是回去尋找答案。',
    '你將先提出假說、用實驗留下證據，再決定答案是否應該被送回歷史。',
  ],
}
...
export const CHALLENGES: Record<ChallengeId, ChallengeMeta> = {
  lamp: {
    ...
    clueTag: '殘頁・一',
    clue: '紙角畫著 Ω，但這個電阻單位符號要到數十年後才會正式採用。作者知道未來的科學語言。',
    quiz: {
  ...
  split: {
    ...
    clueTag: '殘頁・二',
    clue: '起筆壓力、等號右端上揚、數字 7 的橫線，都與你的實驗紀錄一致；但 AMP 拒絕判定作者。',
    quiz: {
  ...
  cyclo: {
    ...
    clueTag: '殘頁・三',
    clue: '紙背壓著一張 2225 年的車票痕跡，纖維紋路與你登上時光電弧儀前使用的票完全相同。',
    quiz: {
  ...
  maglock: {
    ...
    clueTag: '殘頁・四',
    clue: '最早的原始掃描已包含紙條，紙張纖維與裝訂壓痕連續一致；它不是後人補進歷史的。',
    quiz: {
  ...
  dynamo: {
    ...
    clueTag: '殘頁・五',
    clue: '法拉第記錄的訪客左手握筆、袖口有電弧灼痕；你的防護服左袖剛出現同樣的痕跡。',
    quiz: {
  ...
  xfmr: {
    ...
    clueTag: '殘頁・六',
    clue: '六張紙都來自你攜帶的同一本實驗簿；每一行內容，也都由你在這趟旅程親手完成。',
    quiz: {
...
export const SOUP_QUESTIONS: SoupQuestion[] = [
  ...
  { id: 'q-handwriting', text: '我見過紙條上的字跡嗎？', answer: 'yes', detail: 'AMP 沉默了一會兒：「它與你的實驗紀錄共享十二項書寫特徵。」', unlockAt: 5 },
  { id: 'q-first-write', text: '紙條存在「第一次被寫下」的時刻嗎？', answer: 'no', detail: '這正是它最不可思議的地方。沒有起點。', unlockAt: 5 },
  { id: 'q-i-wrote', text: '寫下紙條的人……此刻就在時光電弧儀裡嗎？', answer: 'yes', detail: 'AMP 關閉了身分比對警告。艙內只剩你自己的呼吸聲。', unlockAt: 6 },
]
...
export const FINALE = {
  ...
  reveal: [
    ...
    '',
    '導師失蹤前的那句「被人動了手腳」，指的就是你自己。',
    '他離開這條時間線，是因為最後一步不該由他替你選。',
    '',
    '六個模組等待最終指令：閉合、切斷，或改寫迴圈。',
  ],
}
